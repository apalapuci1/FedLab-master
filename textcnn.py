...
# x=torch.load('./datasets/x.pth')
# y=torch.load('./datasets/y.pth')
...
train_db=torch.load('./datasets/new/train_db.pth')
test_db=torch.load('./datasets/new/test_db.pth')
train_db=DataLoader(dataset=train_db,batch_size=128)
test_db=DataLoader(dataset=test_db,batch_size=128)
train(config,model,train_db,test_db)