from src.fedlab.contrib.algorithm.basic_server import SyncServerHandler
from src.fedlab.contrib.algorithm.basic_client import SGDClientTrainer, SGDSerialClientTrainer
from src.fedlab.utils.aggregator import Aggregators
from src.fedlab.utils.serialization import SerializationTool
import numpy as np
import torch
...
from src.fedlab.core.client.trainer import ClientTrainer, SerialClientTrainer
...
class FedAvgSerialClientTrainer(ClientTrainer):
    """Federated client with local SGD solver."""
