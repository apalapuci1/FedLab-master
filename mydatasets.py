...
from src.fedlab.contrib.dataset.basic_dataset import FedDataset, Subset
from src.fedlab.utils.dataset.partition import CIFAR10Partitioner, CIFAR100Partitioner, MNISTPartitioner


class mydataset (FedDataset):
    ...
    def get_dataset(self, cid, type="train"):
        ...
        print(current_dir)
        dataset = torch.load(
            os.path.join("/home/admin/github/src/data/train/3client{}".format(cid)))
        return dataset
